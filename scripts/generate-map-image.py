...
ZOOM = 18
DONOR_ZOOM = 16  # зум, на котором Яндекс ещё не рисует подписи организаций
TILE_W, TILE_H = 650, 450
# Область с фирменными подписями Яндекса ("Лесная Заимка" + "Villa ArtE",
# стоят почти впритык друг к другу) поверх точки маркера — подобрано вручную
# по снимку на зуме {ZOOM}. Захватывает обе целиком: более узкий бокс однажды
# обрезал вторую подпись на середине слова, получалась нечитаемая каша.
LABEL_PATCH_BOX = (280, 198, 455, 282)
