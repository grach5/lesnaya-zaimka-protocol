...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // h-11 (44px) — не дизайнерская мелочь: реальная проверка на мобильном
        // показала h-8 (32px), меньше рекомендованного минимума тач-таргета.
        // Единственные потребители компонента — формы брони (ReserveForm,
        // BookingForm), других мест использования в проекте нет.
