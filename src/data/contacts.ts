...
// Данные — в contacts.json (редактируется через панель /admin/, см.
// src/components/AdminPanel.tsx); tel:/wa.me-ссылки здесь выводятся АВТОМАТИЧЕСКИ
...
export const CONTACTS = {
  ...
  maxMessenger: contactsData.maxMessenger,
