...
// Данные — в halls.json (редактируется через /admin/). slug редактируется в
// панели, но привязан к папке public/img/halls/<slug>/ — менять его у зала
// с уже загруженными фото не стоит (см. AdminPanel.tsx, HallsSection).
